...
The version 0.5.5 is the latest stable version of governify-agreement-analyzer component.
see [release note](http://github.com/isa-group/governify-agreement-analyzer/releases/tag/0.5.5) for details.

For running:

- Download latest version from [0.5.5](http://github.com/isa-group/governify-agreement-analyzer/releases/tag/0.5.5)
